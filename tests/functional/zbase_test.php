...
class zbase_test extends functional_base
{
	...
	public function test_disable_delete()
	{
		...
		self::assertStringContainsString($this->lang('EXTENSION_DELETE_DATA_CONFIRM', 'Advertisement Management'), static::get_content()); // use get_content because lang contains HTML
