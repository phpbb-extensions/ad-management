...
$lang = array_merge($lang, array(
	...
	'AD_OWNER'					=> 'Owner',
	'AD_OWNER_EXPLAIN'			=> 'Assigning an advertisement owner will give one of your board members permission to view this advertisement‘s view and click statistics in their User Control Panel. Leave this field blank to not assign an advertisement owner.',
	'AD_VIEWS'					=> 'Views',
	...
	'AD_CONSENT_EXPLAIN'		=> 'Set to yes to defer script tags in this advertisement until the visitor allows marketing in Privacy Settings. Set to no only for ad code that does not load marketing, tracking, cookies, or other consent-controlled resources.',
	...
	'AD_OWNER_INVALID'			=> 'The advertisement owner is invalid. Please select a user using the Find a member link.',
	...
	'LOCATION_CHANGE'		=> '<strong>Redirection</strong><br />Your code appears it can redirect a user to another page or site. Redirects can sometimes send users to unintended, often malicious, destinations. Please verify the integrity of your advertisement codeadvertisement code’s redirection destination.',
	...
	'ENABLE_VIEWS_EXPLAIN'			=> 'This will enable counting how many times every advertisement has been displayed. Note, that it adds extra load to the server, so if you do not need this feature, disable it.',
	'ENABLE_CLICKS'					=> 'Count clicks',
	'ENABLE_CLICKS_EXPLAIN'			=> 'This will enable counting how many times every advertisement has been clicked. Note, that it adds extra load to the server, so if you do not need this feature, disable it.',
