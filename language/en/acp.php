...
$lang = array_merge($lang, array(
	...
	'AD_CLICKS_LIMIT_EXPLAIN'	=> 'Set the maximum number of times the ad will be clicked, after which the ad will no longer be displayed. Set 0 for unlimited views. Note, that you have to use {COUNT_CLICKS} placeholder in the ad code in order to have this feature working correctly.',
