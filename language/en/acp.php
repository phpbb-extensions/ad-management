...
$lang = array_merge($lang, array(
	...
	'AD_OWNER_EXPLAIN'			=> 'Assign this ad to a board member. The assigned user can monitor its view and click statistics in their User Control Panel and receive a notification if it is disabled after reaching its end date. Leave this field blank to not assign a user.',
	'AD_VIEWS'					=> 'Views',
	'AD_CLICKS'					=> 'Clicks',
	...
	'CANNOT_INITIALIZE_STORAGE'	=> 'Banner storage could not be initialized. Please make sure the <samp>/images</samp> directory and, if it exists, the <samp>/images/phpbb_ads</samp> directory are writable.',
	...
	'ENABLE_VIEWS_EXPLAIN'			=> 'Count how many times this ad is viewed. Multiple placements on one page count as one view. Repeated views in the same browser tab within 10 seconds count as one view.',
	'ENABLE_CLICKS'					=> 'Count clicks',
	'ENABLE_CLICKS_EXPLAIN'			=> 'Count how many times this ad is clicked. Repeated clicks in the same browser tab within 10 seconds count as one click.',
