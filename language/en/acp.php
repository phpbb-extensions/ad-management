...
$lang = array_merge($lang, array(
	...
	'AD_VIEWS_LIMIT_EXPLAIN'	=> 'Set the maximum number of views the ad will be displayed. Set 0 for unlimited views.',
	'AD_CLICKS_LIMIT'			=> 'Clicks Limit',
	'AD_CLICKS_LIMIT_EXPLAIN'	=> 'Set the maximum number of clicks the ad will be displayed. Set 0 for unlimited clicks. Note, that you have to use {COUNT_CLICKS} placeholder in the ad code in order to have this feature working correctly.',
	...
	'AD_CODE'					=> 'Code',
	'AD_CODE_EXPLAIN'			=> 'Enter the advertisement code here. All code must use HTML markup, BBCodes are not supported. To count ad clicks, use {COUNT_CLICKS} placehoder as attribute.',
