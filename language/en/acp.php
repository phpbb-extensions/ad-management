...
$lang = array_merge($lang, array(
	...
	'AD_LOCATIONS_EXPLAIN'		=> 'Select locations where you want this advertisement displayed. Mouse over a location for a short description of it. If multiple ads use the same location, one ad will be randomly selected to display in that location each time. Use CTRL+CLICK (or CMD+CLICK on Mac) to select/deselect more than one location.<br><br>You can see visual demo of ad locations while browsing board: <a class="button2" href="%s" target="_blank">Start visual demo of ad locations</a>',
	...
	'AD_CONTENT_ONLY_EXPLAIN'	=> 'This ad will only display on pages that contain content. It will not be shown on pages such as the UCP, login, registration, etc. Some advertising platforms (e.g. Google AdSense) require this.',
